...
import Window.Info.ProviderExits;
...
public class ProviderRegister extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(alter_user_name2, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                    .addComponent(alter_user_account2))
                .addGap(26, 26, 26)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private boolean verify(String provider){
        ...
        List<reUser> user =doer.mysqlSelectForAccPas(sql);
        for(reUser temp:user){  
            if(temp.getName().equals(provider)){
                return false;              
            }
        }   
        return true;
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ProviderRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (account.isEmpty() || password2.isEmpty() || name.isEmpty()) {
            ...
            if(verify(name)){
                String sql = "INSERT INTO `provider_users`(`id`,`account`,`password`,`name`)\n"
                ...
                ProviderExits pro =new ProviderExits();
                pro.show();
            }
        }
